...
// // Promise.allSettled (returns array of all settled promises )
// Promise.allSettled([
...
// // Promise.all (returns array of promises unless one rejects, then it only shows the first reject)
// // Promise.all([
// //   Promise.resolve('Success'),
// //   Promise.reject('ERROR'),
// //   Promise.resolve('Another success'),
