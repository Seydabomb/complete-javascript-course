...
/* ========================= Exporting and Importing in ES6 Modules ============================  */ // Importing Module
...
/* ========================= Top-Level Await (ES2022) ============================  */ // // console.log('Start fetching');
...
/* ========================= The Module Pattern ============================  */ // const ShoppingCart2 = (function () {
//   const cart = [];
...
/* ========================= CommonJS Modules ============================  */ // export.addToCart = function (product, quantity) {
//     cart.push({ product, quantity });
//     console.log(
//         `${quantity} ${product} added to cart (shipping cost is ${shippingCost})`
//     );
...
/* ============================== Intro to NPM ================================  */ var _cloneDeepJs = require("./node_modules/lodash-es/cloneDeep.js");
...
const stateClone = Object.assign({}, state);
const stateDeepClone = (0, _cloneDeepJsDefault.default)(state); // using the imported thing
state.user.loggedIn = false;
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire94c2")
