...
const startLogOutTimer = function () {
  const tick = function () {
    const min = String(Math.trunc(time / 60)).padStart(2, 0); // That way we are seeing only the integers with a 0 padded in the front
...
// const future = new Date(2037, 10, 19, 15, 23);
// console.log(+future); // outputs the number 2142282180000

// const calcDaysPassed = (date1, date2) =>
//   Math.abs(date2 - date1) / (1000 * 60 * 60 * 24);
// const days1 = calcDaysPassed(new Date(2037, 3, 4), new Date(2037, 3, 14));
// console.log(`${days1} days`); // outputs 10 days
...
//   3000,
//   ...ingredients
// ); // after 3 seconds, the console displays the string
// console.log('Waiting...');
...
//   const now = new Date();
//   console.log(now);
// }, 1000); // logging the new date every second
